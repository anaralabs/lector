...
| --- | --- |
| Name | `lector` |
| Server URL | `https://lector-weld.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "lector": {
      "url": "https://lector-weld.vercel.app/mcp"
    }
  }
}
```
...
```bash
curl -fsSL https://lector-weld.vercel.app/llms.txt
curl -fsSL https://lector-weld.vercel.app/docs/code/search.md
```
